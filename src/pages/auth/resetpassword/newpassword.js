        ...
        <div className="bg-white w-4/12">
            <div className="p-10">
                ...
                <div className="border border-gray-200 rounded p-2">
                    ...
                    <div className="mb-4">
                        <input type="password" className="w-full text-black rounded" placeholder="New Password" />
                    </div>
                    <div className="mb-4">
                        <input type="password" className="w-full text-black rounded" placeholder="Verify New Password" />
                    </div>
                    <div className="mb-4">
